        ...
        return myStudentData ? (
          <div className="flex flex-col items-center justify-center p-8 bg-gray-50 min-h-screen">
            ...
            <button 
              ...
              className="mt-6 bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-medium shadow-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {downloading ? 'Generating PDF...' : 'Download ID Card (PDF)'}
            </button>
          </div>
        ) : (
          <div className="p-8 text-center text-gray-500 bg-white rounded-xl shadow-sm max-w-md mx-auto mt-10">
